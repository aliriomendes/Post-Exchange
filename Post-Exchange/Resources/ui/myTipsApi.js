function loadLatest(CurrentTable, actInd){ 
	...
	var xhr, jsonObject, userId, title,tipTitle, tip, id, data, i, image,TipContainer,imageContainer,userID;
	
	//Create the request
	xhr = Titanium.Network.createHTTPClient();
	userID = Ti.App.Properties.getString('userID');
	// Set the URL 
	xhr.open("GET", "http://aliriomendes.com/workshop//api.php?mode=latest_mytips&id="+userID);
	//On success do this
	xhr.onload = function () {
	//initialize array
	data = [];
