...
//Rare exceptions to indicate a bug in the _postexchange code (Eg, function that a subclass should have implemented)
...
/**
 The base class for PostExchange proxies.
 */
