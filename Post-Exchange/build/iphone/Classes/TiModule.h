...
/**
 The base class for all PostExchange modules
 */
...
/**
 PostExchange Platform calls this method on startup.
 */
-(void)startup;

/**
 PostExchange Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 PostExchange Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 PostExchange Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 PostExchange Platform calls this method on resume.
 @param sender The sender of the event.
 */
