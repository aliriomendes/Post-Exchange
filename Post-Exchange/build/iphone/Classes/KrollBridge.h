...
@interface PostExchangeObject : KrollCoverageObject {
#else
@interface PostExchangeObject : KrollObject {
#endif
@private
...
extern NSString * PostExchange$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	PostExchangeObject *_postexchange;
    KrollObject* console;
	BOOL shutdown;
