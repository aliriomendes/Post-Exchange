...
/**
 Base class for all PostExchange views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the PostExchange view hierarchy (such as wrapped iOS UIViews) was touched.
