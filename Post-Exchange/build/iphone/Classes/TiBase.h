...
// in simulator we redefine to format for PostExchange Developer console
...
{\
	NSString * exceptionName = [@"org.postexchange." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.postexchange";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPostExchangeNativeItemNone = -1, 
	UIPostExchangeNativeItemSpinner = -2,
	UIPostExchangeNativeItemProgressBar = -3,
	
	UIPostExchangeNativeItemSlider = -4,
	UIPostExchangeNativeItemSwitch = -5,
	UIPostExchangeNativeItemMultiButton = -6,
	UIPostExchangeNativeItemSegmented = -7,
	
	UIPostExchangeNativeItemTextView = -8,
	UIPostExchangeNativeItemTextField = -9,
	UIPostExchangeNativeItemSearchBar = -10,
	
	UIPostExchangeNativeItemPicker = -11,
	UIPostExchangeNativeItemDatePicker = -12,
	
	UIPostExchangeNativeItemInfoLight = -13,
	UIPostExchangeNativeItemInfoDark = -14,
	
	UIPostExchangeNativeItemDisclosure = -15,
	
	UIPostExchangeNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all PostExchange instances of
