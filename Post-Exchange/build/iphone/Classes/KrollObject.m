...
//@interface PostExchangeObject : NSObject
//@end

@interface PostExchangeObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[PostExchangeObject class]])
		{
			for (NSString *key in [[(PostExchangeObject*)o modules] allKeys])
			{
